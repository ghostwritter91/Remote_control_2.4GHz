...
SI_SBIT(BSP_DISP_EN, SFR_P2, 6);
SI_SBIT(BSP_DISP_CS, SFR_P1, 5);
...
SI_SBIT(BSP_LED_G, SFR_P2, 0);
SI_SBIT(BSP_LED_B, SFR_P2, 1);
SI_SBIT(BSP_LED_R, SFR_P2, 2);

SI_SBIT(BSP_BC_EN, SFR_P1, 4);
